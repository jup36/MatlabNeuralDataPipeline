function plotReachAnglesSeparateMeanOnFig(figObj, angleCells, meanAngleCells, colorCells, meanColorCells, lineWidth)
    ...
    for i = 1:length(angleCells)
        ...
        mean_angle_degree = meanAngleCells{i}; 
        ...
        mean_angle_radian = mean_angle_degree * (pi / 180) + pi/2;
        ...
        mean_angle_radians = atan2(mean(sin(mean_angle_radian)), mean(cos(mean_angle_radian)));
