function hTrjDecodingKalmanFilter_hTrjF_reach_PosVelXYZ_v1(filePath, saveName)
...
for k = 1:8 % MAIN LOOP (fit X,Y,Z sperately and XYZ altogether) 
    ...
    [s.dat.stateRCtx{k},s.dat.stateRStr{k},s.dat.stateRCtxStr{k}] = leaveOneOutKFdecoderTrialTypeBalanced(tmpState, s.dat.spkCtxR, s.dat.spkStrR, s.dat.laserIdxR, 50); 
