...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_prePull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_pull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_prePull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
% X trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_pull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_prePull_htP1',saveName)),'-dpdf','-painters','-bestfit')
% X trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_pull_htP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_prePull_htP2',saveName)),'-dpdf','-painters','-bestfit')
% X trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('xPos_interp_pull_htP2',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_prePull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_pull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_prePull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
% Y trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_pull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_prePull_htP1',saveName)),'-dpdf','-painters','-bestfit')
% Y trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_pull_htP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_prePull_htP2',saveName)),'-dpdf','-painters','-bestfit')
% Y trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('yPos_interp_pull_htP2',saveName)),'-dpdf','-painters','-bestfit')
...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_whole_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_prePull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_pull_ltP1',saveName)),'-dpdf','-painters','-bestfit')
...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_whole_ltP2',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PRE-PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_prePull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_pull_ltP2',saveName)),'-dpdf','-painters','-bestfit')
...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_whole_htP1',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PRE-PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_prePull_htP1',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_pull_htP1',saveName)),'-dpdf','-painters','-bestfit')
...
ylim([-6 12])
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_whole_htP2',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PRE-PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_prePull_htP2',saveName)),'-dpdf','-painters','-bestfit')
% Z trj, low torque, position 1(left), Cortex, Striatum, Actual PULL trajectory
figure; 
...
print(fullfile(filePath,'Figure','KalmanFilter_decoding',strcat('zPos_interp_pull_htP2',saveName)),'-dpdf','-painters','-bestfit')
...
stateCC_sm = smooth2a(stateCC,3,0); 
stateCtxCC_sm = smooth2a(stateCtxCC,3,0); 
stateStrCC_sm = smooth2a(stateStrCC,3,0); 
...
%% movie a trajectory
xs = [stateCtxCC(:,1), stateStrCC(:,1), stateCC(:,1)]'; % x traj actual, cortex, striatum
ys = [stateCtxCC(:,2), stateStrCC(:,2), stateCC(:,2)]'; % y traj actual, cortex, striatum
zs = [stateCtxCC(:,3), stateStrCC(:,3), stateCC(:,3)]'; % z traj actual, cortex, striatum
