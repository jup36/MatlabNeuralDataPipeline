...
def feature_extraction_command_line_parser(parser):
    ...
    parser.add_option("-e", "--executable_name", dest="executable_name", help="executable", metavar="executable_name", default="TNC_MM_SummarizeResults")
...
def compile_code(options):
    input_path      = os.path.join(tonic_home,"MixtureModel", \
