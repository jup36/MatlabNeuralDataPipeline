fileDirectory = '/Users/parkj/Documents/BehavioralData/Austin/';
cd(fileDirectory)
...
for i = 1:size(allFiles,1)
    ...
    % Correction for this is made below by adding the lag corresponding to
    % each trial to the time marked in Arduino
