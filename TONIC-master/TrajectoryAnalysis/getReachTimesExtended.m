function [ reachStart, reachStop, reachMW, pos1, pos2, xpos1, ypos1, xpos2, ypos2 ] = getReachTimesExtended( positionData, TbetweenR, maxDur, velCutOffPerc )
...
cutoffd = sortVel(round(length(sortVel)*velCutOffPerc));    % set the 98% cutoff for the velocity data (velocity cutoff is required, since reaches are expected to occur at high velocity)
