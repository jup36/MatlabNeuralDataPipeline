function [halo cl] = TNC_SSPL_cluster_dp(xx,interactive)
...
for i=1:N
  dist(xx(i,1),xx(i,2)) = xx(i,3);
  dist(xx(i,2),xx(i,1)) = xx(i,3);
end
...
title ('Decision Graph - Draw box around cluster points','FontSize',15.0)
xlabel ('\rho')
ylabel ('\delta')
