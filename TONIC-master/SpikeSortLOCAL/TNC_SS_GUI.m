...
% Last Modified by GUIDE v2.5 10-Jun-2015 17:30:55
...
% --- Executes on button press in checkOverlay.
function checkOverlay_Callback(hObject, eventdata, handles)
% hObject    handle to checkOverlay (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkOverlay
...
function fillClustEdit_Callback(hObject, eventdata, handles)
% hObject    handle to fillClustEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fillClustEdit as text
%        str2double(get(hObject,'String')) returns contents of fillClustEdit as a double


% --- Executes during object creation, after setting all properties.
function fillClustEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fillClustEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in manClustFill1.
function manClustFill1_Callback(hObject, eventdata, handles)
% hObject    handle to useConfidence1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    ...
    % For points that are not in, leave them alone unless they have the
    % number of the current cluster; then they should be zeroed
    [newIds] = TNC_SS_CropCluster(handles,1);
