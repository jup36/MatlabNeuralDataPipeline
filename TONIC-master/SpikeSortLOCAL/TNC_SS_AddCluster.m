function [newClustIds] = TNC_SS_AddCluster(handles,newId)
    ...
    inTheHull = inpolygon(handles.featureData.seg(handles.segList(1)).shank(handles.shankNum).params(:,handles.xPlotNum),handles.featureData.seg(handles.segList(1)).shank(handles.shankNum).params(:,handles.yPlotNum),newX,newY);
