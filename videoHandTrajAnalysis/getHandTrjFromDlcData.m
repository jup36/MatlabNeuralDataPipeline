...
for t = 1:length(fVideoInfo) % increment trials of jsTime1k_KV
    ...
    if isstruct(fVideoInfo{t}) && isstruct(sVideoInfo{t})
        ...
        if sum(fIdx)==1 && sum(sIdx)==1
            ...
            trj3d(t).js1SgFronXYZ(1,:) = trj3d(t).js1SgFron(1,:); 
            trj3d(t).js1SgFronXYZ(2,:) = trj3d(t).js1SgFron(3,:); 
            trj3d(t).js1SgFronXYZ(3,:) = -trj3d(t).js1SgFron(2,:); 
            
            trj3d(t).js1SgSideXYZ(1,:) = trj3d(t).js1SgSide(1,:);
            trj3d(t).js1SgSideXYZ(2,:) = trj3d(t).js1SgSide(3,:);
            trj3d(t).js1SgSideXYZ(3,:) = -trj3d(t).js1SgSide(2,:);
            
            trj3d(t).js2SgFronXYZ(1,:) = trj3d(t).js2SgFron(1,:); 
            trj3d(t).js2SgFronXYZ(2,:) = trj3d(t).js2SgFron(3,:); 
            trj3d(t).js2SgFronXYZ(3,:) = -trj3d(t).js2SgFron(2,:); 
            
            trj3d(t).js2SgSideXYZ(1,:) = trj3d(t).js2SgSide(1,:);
            trj3d(t).js2SgSideXYZ(2,:) = trj3d(t).js2SgSide(3,:);
            trj3d(t).js2SgSideXYZ(3,:) = -trj3d(t).js2SgSide(2,:);
        end
    end
    clearvars tmp*
