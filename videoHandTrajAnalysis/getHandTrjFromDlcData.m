...
firstFron = VideoReader(fullfile(filePath,vFolderName,kv(fronIdx).fVideoInfo.name)); 
firstSide = VideoReader(fullfile(filePath,vFolderName,kv(sideIdx).sVideoInfo.name)); 
