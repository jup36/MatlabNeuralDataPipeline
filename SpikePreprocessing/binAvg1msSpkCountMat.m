function [ binAvgMat, binEdges ] = binAvg1msSpkCountMat( SpkCountMat1ms, binSize, stepSize, varargin )
...
binAvgMat = []; % initialize binned spike count mat
...
binAvgMat = binAvgMat./repmat((binEdges(2,:)-binEdges(1,:)+1)/binSize,[size(binAvgMat,1), 1, size(binAvgMat,3)]); 
