function [ unitTimeBOut, binSpkOut, binSpk, params ] = psthBINcellPerTrial_step( neural, behav, binsize, stepsize, psthWin )
...
params.stepSize = stepsize;   % store step size
...
for u = 1:size(neural,2)   % increment units
    ...
    [binSpkOut.unitTimeB(u,:)] = bin1msSpkCountMat(tmpUnitTrialTimeMat,params.binSize,params.stepSize);  % get current unit's binned spikeCountMat (e.g. 20ms bin) 
