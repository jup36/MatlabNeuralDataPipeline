function [ unitTimeBOut, binSpkOut, binSpk, params ] = psthBINcellPerTrial1msBin( neural, behav, binsize, psthWin )
...
for u = 1:size(neural,2)   % increment units
    ...
    [binSpkOut.unitTimeB(u,:)] = bin1msSpkCountMat(tmpUnitTrialTimeMat,params.binSize,params.binSize, 'align', 'subsequent');  % get current unit's binned spikeCountMat (e.g. 20ms bin) 
