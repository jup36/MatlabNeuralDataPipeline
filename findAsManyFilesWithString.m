function folderPath = findAsManyFilesWithString(directory, searchString)
    ...
    for i = 1:length(dirContents)
        ...
        if isfile(fullfile(dirContents(i).folder, dirContents(i).name)) && contains(itemName, searchString)
