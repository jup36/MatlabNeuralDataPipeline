...
filePath = {'/Volumes/Beefcake/Junchol_Data/JS2p0/WR40_090519'};

saveName = {'WR40_090519'};
...
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_CtxStr'),'-dpdf','-painters')
%save(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData','dPrime_CtxStr_collectRez'),'dPrmRez')
...
hold off; 
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_Ctx_scatter'),'-dpdf','-painters')
...
for tp = 1:5:100
    ...
    for cc = 1:length(dPrmRezCtx)      
        ...
        if dPrmRezCtx(cc).s.dist2d_cdf_p(tp)<0.01
    ...
    print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure/dPrm_snapShot',strcat('dPrime_Ctx_scatter_snapShots_ipsi',sprintf('%d',timeX(tp)),'ms')),'-dpdf','-painters')
    close all
end
hold off;
...
hold off; 
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_Str_scatter'),'-dpdf','-painters')
...
for tp = 1:5:100
    ...
    for cc = 1:length(dPrmRezStr)      
        ...
        if dPrmRezStr(cc).s.dist2d_cdf_p(tp)<0.01
            scatter(currPt(1),currPt(2),50, 'MarkerEdgeColor', [.25 .25 .25], 'MarkerFaceColor', thisColor, 'LineWidth', .5,  'MarkerFaceAlpha',.5)
        else
            scatter(currPt(1),currPt(2),25, 'MarkerEdgeColor', [.25 .25 .25], 'MarkerFaceColor', [.25 .25 .25], 'LineWidth', .5,  'MarkerFaceAlpha',.5)
        end
    ...
    hText1 = text(0.90,-1.75,strcat(sprintf('%d',timeX(tp)),'ms'),'FontSize',18); 
    print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure/dPrm_snapShot',strcat('dPrime_Str_scatter_snapShots_ipsi',sprintf('%d',timeX(tp)),'ms')),'-dpdf','-painters')
    close all
end
hold off;
...
hold off
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_CtxStr_proportionPie'),'-dpdf','-painters')
...
hold off
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_Ctx_proportionPie'),'-dpdf','-painters')
...
hold off
%print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure','dPrime_Str_proportionPie'),'-dpdf','-painters')
dPrmType_Str_distribution = cell2mat(cellfun(@(a) size(a,1), dPrmTtC_str, 'un', 0))./ttNumbStr; 

%save(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData','dPrime_CtxStr_collectRez'),'dPrmTtC_str','dPrmTtC_ctx','dPrmTtC','-append')
...
for tt = 1:8
    ...
    print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/collectFigure',strcat('dPrime_2dTrj_',sprintf('trialType#%d',tt))),'-dpdf','-painters')
    close all
end 
...
video = VideoWriter(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData','exampleTrj_eachTrialType'),'MPEG-4');
video.Quality = 100;
video.FrameRate = 20;
open(video)
writeVideo(video,F)
