...
ylim([-20 15])
%print(fullfile(figSaveDir,'blockwise_rchAngle_med_sub_m_b_combined'), '-dpdf', '-painters')
...
ylim([2 6])
%print(fullfile(figSaveDir,'blockwise_tortuosity_m_b_combined'), '-dpdf', '-painters')
...
ylim([0 140])
%print(fullfile(figSaveDir,'blockwise_pull_force_m_b_combined'), '-dpdf', '-painters')
...
ylim([40 100])
%print(fullfile(figSaveDir,'blockwise_success_rate_m_b_combined'), '-dpdf', '-painters')
...
ylim([100 550])
%print(fullfile(figSaveDir,'blockwise_rch_dur_m_b_combined'), '-dpdf', '-painters')
...
ylim([100 200])
%print(fullfile(figSaveDir,'blockwise_pull_dur_m_b_combined'), '-dpdf', '-painters')
