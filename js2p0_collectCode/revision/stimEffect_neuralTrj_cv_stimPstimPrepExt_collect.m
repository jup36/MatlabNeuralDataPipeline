...
save(fullfile('/Volumes/Extreme SSD/js2p0/collectData', ['stimEffect_neuralTrj_rrr_stimPstimPrepExtWoTo', sprintf('_Dims%d', dims), sprintf('_Folds%d', folds)]), 'mR2*', 'medR2*')
...
save(fullfile('/Volumes/Extreme SSD/js2p0/collectData', ['stimEffect_neuralTrj_rrr_stimPstimPrepExtWoTo', sprintf('_Dims%d', dims), sprintf('_Folds%d', folds)]), 'stat', '-append')
