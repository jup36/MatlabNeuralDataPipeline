...
for f = 1:length(filePaths) 
    load(fullfile(filePaths{f}, 'magnitude_inhibition_breakThrough_str'), 'rez')
...
scatter_row_by_row_fillLogic([magInhAll, magBtAll, magReachAll], [-2 5], sigInhAll); 
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure', 'cortical_inactivation_breakThrough_normalReach_allStrUnits'), '-dpdf', '-vector', '-bestfit')

scatter_row_by_row_fillLogic([magInhAll(sigInhAll), magBtAll(sigInhAll), magReachAll(sigInhAll)], [-2 5], ones(sum(sigInhAll), 1)); 
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure', 'cortical_inactivation_breakThrough_normalReach_sigInhStrUnits'), '-dpdf', '-vector', '-bestfit')
...
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure', 'cortical_breakThrough_corticalReach_allStrUnits'), '-dpdf', '-vector', '-bestfit')
