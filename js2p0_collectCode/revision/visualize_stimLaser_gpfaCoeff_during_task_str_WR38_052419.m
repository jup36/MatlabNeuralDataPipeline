...
filePath = '/Volumes/Extreme SSD/js2p0/WR38_052419/Matfiles'; 
load(fullfile(filePath, strcat('js2p0_tbytSpkHandJsTrjBin_50ms_stimParse_', 'WR38_052419')),'ss', 'jkvt'); 
%load(fullfile('/Volumes/Extreme SSD/js2p0/collectData', 'js2p0_behavior_stat_rez_inactivation.mat'), 'rezCol', 'rez', 'stat', 'trI') 
%filePath_gpfa = '/Volumes/Extreme SSD/js2p0/WR38_052419/Matfiles/gpfa_str'; 
%load(fullfile(filePath_gpfa, 'gpfaRezStr.mat'), 'gpfaRezStr'); 

figSaveDir = '/Volumes/Extreme SSD/js2p0/WR38_052419/Matfiles/Figure'; 
