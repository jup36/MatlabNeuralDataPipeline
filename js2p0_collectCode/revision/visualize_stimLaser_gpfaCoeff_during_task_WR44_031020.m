...
filePath = '/Volumes/Extreme SSD/js2p0/WR44_031020/Matfiles'; 
load(fullfile(filePath, strcat('js2p0_tbytSpkHandJsTrjBin_50ms_stimParse_', 'WR44_031020')),'ss', 'jkvt'); 
load(fullfile('/Volumes/Extreme SSD/js2p0/collectData', 'js2p0_behavior_stat_rez_inactivation.mat'), 'rezCol', 'rez', 'stat', 'trI') 
filePath_gpfa = '/Volumes/Extreme SSD/js2p0/WR44_031020/Matfiles/gpfa_ctx'; 
load(fullfile(filePath_gpfa, 'gpfaRezCtx.mat'), 'gpfaRezCtx'); 

figSaveDir = '/Volumes/Extreme SSD/js2p0/WR44_031020/Matfiles/Figure'; 
...
rez.magInh = nanmean(post_stim, 2)-nanmean(pre_stim, 2); 
rez.sigInhI = rez.magInh(logical(ttestRez)); 
