...
filePath = {'/Volumes/Extreme SSD/js2p0/WR37_022119', ... % B Only
    '/Volumes/Extreme SSD/js2p0/WR37_022219', ... % B Only
    '/Volumes/Extreme SSD/js2p0/WR37_022619', ... % Cg recording contra-Cg silencing
    '/Volumes/Extreme SSD/js2p0/WR37_022719', ... % B Only contra-Cg delayed silencing
    '/Volumes/Extreme SSD/js2p0/WR38_052119', ... % Dual recording without silencing
    '/Volumes/Extreme SSD/js2p0/WR38_052219', ... % Dual recording without silencing
    '/Volumes/Extreme SSD/js2p0/WR38_052319', ... % Cg recording contra-Cg silencing
    '/Volumes/Extreme SSD/js2p0/WR38_052419', ... % Corticostriatal recording M1 silencing
    '/Volumes/Extreme SSD/js2p0/WR39_091019', ... % B Only contra-Cg delayed silencing
    '/Volumes/Extreme SSD/js2p0/WR39_091119', ... % B Only contra-Cg delayed silencing
    '/Volumes/Extreme SSD/js2p0/WR39_100219', ... % Dual recording with contra Cg silencing
    '/Volumes/Extreme SSD/js2p0/WR39_100319', ... % B Only contra-Cg delayed silencing
    '/Volumes/Extreme SSD/js2p0/WR40_081919', ... % Dual recording with contra Cg silencing
    '/Volumes/Extreme SSD/js2p0/WR40_082019', ... % Dual recording with contra Cg silencing
    '/Volumes/Extreme SSD/js2p0/WR44_031020'};    % Dual recording with contra Cg delayed silencing
...
%print(fullfile('/Volumes/Extreme SSD/js2p0/collectData\collectFigure','dPrime_CtxStr_vec_norm'),'-dpdf','-painters')
%save(fullfile('/Volumes/Extreme SSD/js2p0/collectData','dPrime_CtxStr_vec_norm_collectRez'),'dPrmRez')
...
hold off;
%print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure','dPrime_Ctx_scatter_vec_norm'),'-dpdf','-painters')
...
%     print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/dPrm_snapShot',strcat('dPrime_Ctx_scatter_snapShots_',sprintf('%d',timeX(tp)),'ms')),'-dpdf','-painters')
%     close all
% end
% hold off;
...
hold off;
%print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure','dPrime_Str_scatter_vec_norm'),'-dpdf','-painters')
...
for tp = 1:5:100
    ...
    hText1 = text(0.90,-1.75,strcat(sprintf('%d',timeX(tp)),'ms'),'FontSize',18);
    print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/dPrm_snapShot',strcat('dPrime_Str_scatter_snapShots_',sprintf('%d',timeX(tp)),'ms')),'-dpdf','-painters')
    close all
end
hold off;
...
hold off
%print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure','dPrime_vec_norm_CtxStr_proportionPie'),'-dpdf','-painters')
...
for tt = 1:8
    cellToDraw = dPrmTtC{1,tt}(1,3); % draw 10 trials per type
    dPrm_trj = dPrmRez(cellToDraw).s.trj2d; 
    [~, maxI] = max(dPrmRez(cellToDraw).s.trjDistZero); 
    [~, minI] = min(dPrmRez(cellToDraw).s.trjDistZero(maxI:end)); 
    endI = min(maxI + minI, size(dPrm_trj, 1)); 
    plot2d(smooth2a(dPrm_trj(1:endI, :), 3, 0))
end
...
for tt = 1:8
    ...
    for cc = 1:length(cellToDraw)
        ...
        ttPval = dPrmRez(cellToDraw(cc)).s.trjDistZero_sigI;
    ...
    print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure',strcat('dPrime_2dTrj_',sprintf('trialType#%d',tt))),'-dpdf','-painters')
    close all
end
...
for tt = 1:8
    if ~isempty(dPrmTtC{tt})
        ...
        ttPval1{1,tt} = dPrmRez(thisCell).s.trjDistZero_sigI;
    end
end
...
for cc = 1:length(dPrmRez)
    ...
    if ~isempty(dPrmRez(cc).s) && ~isnan(tType)
        ...
        dPrmTrjCell{cc,tType} = dPrmRez(cc).s.trjDistZero';
    end
end
...
% save(fullfile('/Volumes/Extreme SSD/js2p0/collectData','dPrime_CtxStr_vec_norm_collectRez'),'dPrmTrjCell','-append')
