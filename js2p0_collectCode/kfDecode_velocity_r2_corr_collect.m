...
for f = 1:length(filePath)
    ...
    if ~isempty(fileInfo)
        ...
        reach_vel_r2 = organize_r2(r2Rez_reach, reach_vel_r2, f+1, 7, save_name);
        % reach velocity
    ...
    if ~isempty(fileInfo)
        ...
        pull_vel_r2 = organize_r2(r2Rez_pull, pull_vel_r2, f+1, 7, save_name);
        % pull velocity
        pull_vel_corr = organize_corr(corrRez_pull, pull_pos_corr, f+1, 8, save_name);
        pull_vel_r2 = organize_r2(r2Rez_pull, pull_vel_r2, f+1, 8, save_name);
    end
    fprintf('processed file #%d\n', f)
end

%% reach position overall R2, CTX-STR
r2_ctx_str_reach = plot_r2_ctx_str(reach_vel_r2, [0 .5], 4);  % plot ctx-str R2 reach
...
r2_ctx_str_reach_X = plot_r2_ctx_str_x(reach_vel_r2, [0 .5]);  % plot ctx-str R2 reach
...
r2_ctx_str_reach_Y = plot_r2_ctx_str_y(reach_vel_r2, [0 .5]);  % plot ctx-str R2 reach
...
r2_ctx_str_reach_Z = plot_r2_ctx_str_z(reach_vel_r2, [0 .5]);  % plot ctx-str R2 reach
...
r2_ctx_str_pull = plot_r2_ctx_str(pull_vel_r2, [.2 .8], 4);  % plot ctx-str R2 pull
...
r2_ctx_str_pull_X = plot_r2_ctx_str_x(pull_vel_r2, [.2 .8]);  % plot ctx-str R2 pull
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_X'), '-dpdf', '-vector')
...
r2_ctx_str_pull_Y = plot_r2_ctx_str_y(pull_vel_r2, [.2 .8]);  % plot ctx-str R2 pull
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_Y'), '-dpdf', '-vector')
...
r2_ctx_str_pull_Z = plot_r2_ctx_str_z(pull_vel_r2, [.2 .8]);  % plot ctx-str R2 pull
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_Z'), '-dpdf', '-vector')
...
r2_ctx_str_cg_reach = plot_r2_ctx_str_cg(reach_vel_r2, [.1 .8], 4);  % plot ctx-str-cg R2 reach overall
...
r2_ctx_str_cg_reach_X = plot_r2_ctx_str_cg_X(reach_vel_r2, [0 .8]);  % plot ctx-str-cg R2 reach X position
...
r2_ctx_str_cg_reach_Y = plot_r2_ctx_str_cg_Y(reach_vel_r2, [0 .8]);  % plot ctx-str-cg R2 reach Y position
...
r2_ctx_str_cg_reach_Z = plot_r2_ctx_str_cg_Z(reach_vel_r2, [0 .8]);  % plot ctx-str-cg R2 reach Z position
...
r2_ctx_str_cg_pull_X = plot_r2_ctx_str_cg_pull_X(pull_vel_r2, [0 .8]);  % plot ctx-str-cg R2 pull X position
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_cg_X'), '-dpdf', '-vector')
...
r2_ctx_str_cg_pull_Y = plot_r2_ctx_str_cg_pull_Y(pull_vel_r2, [0 .9]);  % plot ctx-str-cg R2 pull Y position
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_cg_Y'), '-dpdf', '-vector')
...
r2_ctx_str_cg_pull_Z = plot_r2_ctx_str_cg_pull_Z(pull_vel_r2, [0 .8]);  % plot ctx-str-cg R2 pull Z position
print(fullfile('/Volumes/Extreme SSD/js2p0/collectData/collectFigure/KF_decoder', 'pull_vel_r2_ctx_str_cg_Z'), '-dpdf', '-vector')
...
r2_ctx_str_cg_pull = plot_r2_ctx_str_cg(pull_vel_r2, [0 .8]);  % plot ctx-str-cg R2 pull
%print(fullfile('/Users/parkj/Desktop/js2p0_temp_ncm', 'pull_vel_r2_ctx_str_cg'), '-dpdf', '-vector')
...
plot_within_reach_vs_pull(reach_vel_r2, pull_vel_r2, 'ctx', [.2 .8])

plot_within_reach_vs_pull(reach_vel_r2, pull_vel_r2, 'str', [.2 .8])

plot_within_reach_vs_pull(reach_vel_r2, pull_vel_r2, 'cg', [.1 .6])

save(fullfile('/Volumes/Extreme SSD/js2p0/collectData', 'kfDecode_r2_rez'), 'anova_rez', 'reach_vel_r2', 'pull_vel_r2')
