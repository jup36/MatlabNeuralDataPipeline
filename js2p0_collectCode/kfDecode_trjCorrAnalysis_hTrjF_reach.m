...
filePath = {'/Volumes/Beefcake/Junchol_Data/JS2p0/WR37_022119/Matfiles'...,
             ...
             '/Volumes/Beefcake/Junchol_Data/JS2p0/WR40_082019/Matfiles'...,
             '/Volumes/Beefcake/Junchol_Data/JS2p0/WR44_031020/Matfiles'};
figSavePath = '/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/kfDecodeCorrKinematics/reach'; 

%% load corrRez structure and collect data
for f = 1:length(filePath)
    %% Position data
    % correlation for position XYZ
    dirP = dir(fullfile(filePath{f},'rezKFdecodeHTrjCtxStrPos_reach_hTrjF_WR*')); % note that all files are decoding allocentric positions and saved with names 'rezKFdecodeHTrjCtxStrPos_WR' (without 'hTrjF' in their filenames)
    ...
    dirP = dir(fullfile(filePath{f},'rezKFdecodeHTrjCtxStrVel_reach_hTrjF_WR*'));
...
%% save
save(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData/kfDecodeCorrKinematics','trjCorrAnalysis_hTrjF_reachPosVel'),'c')
