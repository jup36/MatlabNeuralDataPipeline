function evtInS = timestamp_behav_events_noEarlyDetectPhotoDiode(path_raw, redetect_logic, varargin)
            ...
            case 'lick'
                if ~(exist('evtInS', 'var')==1 && isfield(evtInS, 'lick'))
                    ...
                    lickIdx = detecteventbythreshold_noAbs(path_raw, lick, nSamp, 50, 'lick', ...
                        'stdFactor', 1, 'plotRez', true, 'chunkPulses', false, 'correctLongPulse', true);
