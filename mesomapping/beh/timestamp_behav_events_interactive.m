        ...
        switch varargin{jj}
            ...
            case 'cmosTrig'
                if ~(exist('evtInS', 'var')==1 && isfield(evtInS, 'cmosTrig'))
                    ...
                    timeStampSec = timeStamp./sample_rate;
                    [cmosTrigRiseIdx, ~, cmosTrigTrainIdx] = detecteventbythreshold_interactive(path_raw, cmosTrig, nSamp, 5, 'cmosTrig', ...
                        'stdFactor',0.5, 'plotRez', true,...
            ...
            case 'topRed'
                if ~(exist('evtInS', 'var')==1 && isfield(evtInS, 'topRed'))
                    ...
                    timeStampSec = timeStamp./sample_rate;
                    [topRedRiseIdx, ~, topRedTrainIdx] = detecteventbythreshold_interactive(path_raw, topRed, nSamp, 5, 'topRed', ...
                        'stdFactor', 1, 'plotRez', true,...
                        'chunkPulses', true, 'chunkInterval', 500, 'correctLongPulse', false, ...
            ...
            case 'sideGreen'
                if ~(exist('evtInS', 'var')==1 && isfield(evtInS, 'sideGreen'))
                    ...
                    timeStampSec = timeStamp./sample_rate;
                    [sideGreenRiseIdx, ~, sideGreenTrainIdx] = detecteventbythreshold_interactive(path_raw, sideGreen, nSamp, 5, 'sideGreen', ...
                        'stdFactor', 1, 'plotRez', true,...
                        'chunkPulses', true, 'chunkInterval', 500, 'correctLongPulse', false, ...
                        'filterArtifact', false, 'lowpassCutoff', 1, 'nyquist', 100, 'removeOffTrainPulses', true, ...
                        'detectLater', 0, 'detectEarlier', 0); % CMOS trigger
