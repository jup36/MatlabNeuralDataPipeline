...
filePath_base = compatiblepath('Z:\Rodent Data\dualImaging_parkj\m1613_jRGECO_GRABda');
animalID  = cell2mat(regexp(filePath_base, 'm\d{4}', 'match'));
subFolders = GrabFiles_sort_trials(animalID, 0, {filePath_base});
figSaveDir = compatiblepath(fullfile('/Volumes/buschman/Rodent Data/dualImaging_parkj/m1613_jRGECO_GRABda', 'collectFigure'));
