...
filePath = {'/Volumes/Beefcake/Junchol_Data/JS2p0/WR38_050319'...
    '/Volumes/Beefcake/Junchol_Data/JS2p0/WR38_052319',...
    '/Volumes/Beefcake/Junchol_Data/JS2p0/WR39_090319',...
    '/Volumes/Beefcake/Junchol_Data/JS2p0/WR40_081219',...
...
yticks(0:.1:1);
set(gca,'TickDir','out')
print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData','pullStartTime_lowTq_pStim_Stim_contraCg'),'-dpdf','-painters')
...
yticks(0:.1:1);
set(gca,'TickDir','out')
print(fullfile('/Volumes/Beefcake/Junchol_Data/JS2p0/collectData','pullStartTime_highTq_pStim_Stim_contraCg'),'-dpdf','-painters')

% plot cumulative pullStart
figure; hold on; 
plot(edges(1:end-1), rStart.pStimlTqHcNormCumSum)
plot(edges(1:end-1), rStart.stimlTqHcNormCumSum)
hold off; 
