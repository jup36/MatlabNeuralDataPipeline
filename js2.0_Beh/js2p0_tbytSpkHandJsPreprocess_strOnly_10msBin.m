function js2p0_tbytSpkHandJsPreprocess_strOnly_10msBin(filePath,saveName)
...
save(fullfile(filePath,strcat('js2p0_tbytSpkHandJsTrj10msBin_',saveName)),'ss','jkvt','trI','spkTimesCell','depthStr')
