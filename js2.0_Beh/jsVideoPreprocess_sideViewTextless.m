function jsVideoPreprocess_sideViewTextless(filePath, nTr, varargin)
...
for i = 1:length(nTr)
    ...
    videoNameTag = '_sideViewOnly'; 
    
    %videoPlayer = vision.VideoPlayer;
    % new video
    outputVideo = VideoWriter(fullfile(tbytVideoPath,strcat(tbytVideoName,videoNameTag)),'MPEG-4');
