function behaviorTimestampsSwitchWrapper(filePath, varargin)
%This is a wrapper function to run behaviorTimestampsSwitch.
...
for f = 1:length(filePath) 
    ...
    p = parse_input_Switch(currentPath, varargin); 
    % p = parse_input_Switch(filePath, {'trialTimeout',20000,'laserUsed',true, 'tagLaserUsed', false, 'reReadBin',false}); 
    behaviorTimestampsSwitch(p);
end
