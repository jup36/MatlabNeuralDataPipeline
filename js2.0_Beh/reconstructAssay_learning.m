function [trialInfo] = reconstructAssay_learning(trialsCsv, trStartIdx, rwdIdx)
...
rPos1s = trialsCsv{trialsCsv.set_in_assay==0,'reach_position_1'}; % reach Position1s in the 1st set 
pullTqs = trialsCsv{trialsCsv.set_in_assay==0,'pull_torque'}; % pull torques in the 1st set
trialNumb = trialsCsv{trialsCsv.set_in_assay==0,'trial'}; % trialNumb within each block of the 1st set
