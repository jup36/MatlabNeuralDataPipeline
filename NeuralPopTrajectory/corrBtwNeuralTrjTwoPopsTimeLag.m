...
for d = 1:size(nTrjMat1,1) % increment dimension (e.g. 5-d)
    ...
    for dd = 1:size(nTrjMat2,1) % increment dimension
        ...
        if d <=3 && dd <=3
            ...
            titleImg12 = [nTrjCorrCell12Name, pcId, 'Pop1toPop2'];
            titleImg21 = [nTrjCorrCell12Name, pcId, 'Pop2toPop1'];
            
            surfMatrix( filePath, triu(nTrjCorrCell12{d,dd,1}), triu(nTrjCorrCell12{d,dd,2}), cAxisValue, 'parula', titleImg12 )
            surfMatrix( filePath, triu(nTrjCorrCell12{d,dd,1}')', triu(nTrjCorrCell12{d,dd,2}')', cAxisValue, 'parula', titleImg21 )
