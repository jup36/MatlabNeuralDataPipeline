...
% p = parse_input_runPCA( filePath, fileName, saveNameTag, { 'frHighPass', 1, 'frLowPass', 50, 'timeRange', [-3e3 2e3], 'pcaBinSize', 50, 'pcaDim', 5, 'pcaKernSD', 50, 'fullCrossVal', false,'xcorThresholdPer', 0.2, 'crossValFolds', 0,  'baseSubtrt', true, 'sqrtSC', false } ); % use this when running line-by-line
