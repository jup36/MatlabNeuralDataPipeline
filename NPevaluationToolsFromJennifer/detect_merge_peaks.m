...
tic
    ...
    for i = 1:nBatch-1
         ...
         % Calculate thresholds for this batch, want to get the MAD (mean absolute deviation) result
...
fprintf( "total number of spikes: %d\n", numel(allTimes));
    ...
    for i = 1:dataChan
        ...
        res.MAD(i) = uVPerBit*mean(res.Thresh(i,:))/qqFactor; % mean absolute deviation
    end
    ...
    allSpike_distJP( fileDir, outName, zMin, zMax, exChan );
    %allSpike_dist( fileDir, outName, zMin, zMax, [141] );
end
