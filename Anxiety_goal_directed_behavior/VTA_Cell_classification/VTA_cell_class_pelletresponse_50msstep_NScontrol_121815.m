...
filedirectory = 'C:\Users\jup36\Desktop\Data\Anxiety_goal_directed_behavior\MAT_Day0';
cd(filedirectory);
fileName = 'SUA_AGB_perievtFR_50msbin_VTA_NScontrol.mat';      % filename for the peri-evt FR
load(fileName,'dat','pellet','tstpbeh','base')   % load neuronal and behavioral dat

saveDirectory = 'C:\Users\jup36\Desktop\Data\Anxiety_goal_directed_behavior\MAT_Day0\VTA_cell_classification';
saveName = 'SUA_AGB_VTA_cellclass_50step_NScontrol_121815';      
...
%% ROC analysis
cd('C:\Users\jup36\Desktop\Data\Anxiety_goal_directed_behavior\MAT_Day0\PeriPellet_VTA_50step100bin_-500to1000')    % directory for the raster data, binned raster data
...
cd(saveDirectory)
save('SUA_AGB_VTA_cellclass_NScontrol_ROC_121815','ROCmat')
...
unitnumb = 61;       % the # of unit of interest (get an idea by looking coefficients)
...
% cluster1 (putative DA cells with responses to reward)
InitParams.mu(1,1) = 0;  % feature 1
InitParams.mu(2,1) = 0;    % feature 2
InitParams.mu(3,1) = -0.4;    % feature 3

InitParams.Sigma(:,:,1) = diag(diag(cov(pc123)));   % Assume that all cluster covariances are initialized to the same covariance matrix 

% cluster2
InitParams.mu(1,2) = 0.2;   % feature 1
InitParams.mu(2,2) = 0;      % feature 2
InitParams.mu(3,2) = 0.5;      % feature 3
