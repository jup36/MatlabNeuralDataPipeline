...
cd('C:\Users\jup36\Desktop\Data\Anxiety_goal_directed_behavior\MAT_Day0')
load('VTA_sua_dat_NScontrol_120415.mat')
load('SUA_AGB_perievtFR_50msbin_VTA_NScontrol')   % load the FR data

cd('C:\Users\jup36\Desktop\Data\Anxiety_goal_directed_behavior\MAT_Day0\VTA_cell_classification')
load('SUA_AGB_VTA_cellclass_50step_NScontrol_121815','EM')
...
close all; clc;
clear s u spike slope inflec x y fail estTime idx result scrsz xValVec
...
DAIdx([5;8;24;25;40;57])=1; % these cells passed a manual visual inspection

%% Save
save('VTA_SUA_unitClassification_NScontrol_010616')
